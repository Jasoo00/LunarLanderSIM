...
class AMRCS2FuelTank:

    def __init__(self, DB):

        params  = DB.AM["AM_RCS2_FUEL_TANK"]
        ...
        self.I_sp    = DB.AM["AM_RCS2_THRUST_CHAMBER1"]["I_sp"]
    ...
    def update(self):
        ...
        self.DB.remaining_fuel[2]   = self.m_p/self.m_p0