    ...
    def run(self):
        ...
        while True:
            ...
            for idx, component in enumerate(self.DB.components):
                ...
                viz2.plot(cubes[0,idx*17:idx*17+17],cubes[1,idx*17:idx*17+17],cubes[2,idx*17:idx*17+17],"k-",alpha=0.5)                
                # viz2.scatter(p_cg[0],p_cg[1],p_cg[2],color='black')
                # viz2.scatter(p_c[0],p_c[1],p_c[2],color='red')
                viz2.quiver(p_cg[0],p_cg[1],p_cg[2],uvec[0],uvec[1],uvec[2],color="red",arrow_length_ratio=0,length=0.1)
